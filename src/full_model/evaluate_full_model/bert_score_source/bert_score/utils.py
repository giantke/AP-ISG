...
def get_model(model_type, num_layers, all_layers=None):
    if model_type.startswith("scibert"):
        ...
        # model = DistilBertModel.from_pretrained("/public/home/zhangke/distilbert-base-uncased")
        model = DistilBertModel.from_pretrained("/mnt/wsl/PHYSICALDRIVE3p1/distilbert-base-uncased")
    else:
...
def get_tokenizer(model_type, use_fast=False):
    ...
    if model_type == "distilbert-base-uncased":
        # tokenizer = DistilBertTokenizer.from_pretrained("/public/home/zhangke/distilbert-base-uncased")
        tokenizer = DistilBertTokenizer.from_pretrained("/mnt/wsl/PHYSICALDRIVE3p1/distilbert-base-uncased")
        return tokenizer
